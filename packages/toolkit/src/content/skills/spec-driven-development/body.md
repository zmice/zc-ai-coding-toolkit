...
3. 编写结构化规格，至少覆盖：
   ...
   - Testing Strategy
   - Boundaries
4. 标记开放问题和风险点；低风险且可验证、可回退的假设写明验证路径后继续
5. 只有问题会改变架构路线、外部契约、数据或安全边界、不可逆操作，或与用户目标冲突时等待人类确认；规格可执行后进入 `planning-and-task-breakdown`
...
- 假设和边界是显式的，而不是藏在正文里
- 成功标准是可测试的，不是感受性描述
- 人类可以基于规格明确批准或驳回高风险路线；低风险任务无需形式化确认也能安全推进
