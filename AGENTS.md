...
- `node apps/cli/dist/cli/index.js platform generate <qwen|codex|claude|opencode|qoder-cn> --plan --json`
- `node apps/cli/dist/cli/index.js platform install <qwen|codex|claude|opencode|qoder-cn> --plan --json`
- `pnpm upstream -- list`
